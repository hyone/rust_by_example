...
fn main() {
    ...
    // `HashMap::get` takes a reference and returns Option<&V>
    ...
    let _ret = contacts.insert("Daniel", "164-6743");
    ...
    // `HashMap::iter` returns an iterator that yields (&'a key, &'a value) pairs
    // in arbitrary order.
